...
class Decoder(nn.Module):
	...
	def forward(self, x):
		...
		pc1_feat = pc1_feat.reshape(-1, self.crop_point_num, 128)
		...
		pc1_xyz = pc1_xyz.reshape(-1, self.crop_point_num, 3) # 512x3 Local Points
		#print('decoder shapes', pc1_xyz.shape, pc2_xyz.shape)
		return pc2_xyz, pc1_xyz